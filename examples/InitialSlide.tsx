...
const InitialSlide: FC<typeof Slider extends ComponentType<infer T> ? Omit<T, 'children'> : never> = (sliderProps) =>  (
    <>
        <h3>Initial on index 3 (slide 4)</h3>
        <Slider {...sliderProps} initialSlideIndex={3}>
